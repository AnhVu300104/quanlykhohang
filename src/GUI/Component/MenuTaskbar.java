...
public class MenuTaskbar extends JPanel {
    ...
    String[][] getSt = {
            ...
            {"Phiếu kiểm kê", "kiemke.svg", "kiemke"},
...
//        pnlCenter.setBorder(new EmptyBorder(0,15,0,35));
        ...
        for (int i = 0; i < getSt.length; i++) {
            ...
            // Chỉ thêm nút Đăng xuất vào pnlBottom
            if ("dangxuat".equals(getSt[i][2])) {
        ...
        // Tăng kích thước pnlCenter để đảm bảo hiển thị đủ
        pnlCenter.setPreferredSize(new Dimension(230, 650)); // Tăng từ 600 lên 650
